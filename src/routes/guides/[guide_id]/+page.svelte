...
<div class="containe mt-3">
    <form onsubmit={requestSubmit} method="POST">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea
                ...
                bind:value={person.message}
            ></textarea>
        </div>

        <button type="submit">
            Request a tour with {guide.first_name} {guide.last_name}</button
        >
    </form>
</div>
